...
const SideNav: FC<Props> = ({ labels, filterLabelId, onSelectLabel, onSubmitNewLabel, onDeleteLabel }) => {
        ...
        <Box sx={modalInnerStyle}>
          <Stack spacing={3}>
            <Stack spacing={1}>
              ...
              <TextField label="new label" variant="filled" fullWidth onChange={(e) => setEditName(e.target.value)} />
              <Box textAlign="right">
            ...
            <Stack spacing={1}>
              {labels.map((label) => (
                <Stack key={label.id} direction="row" alignItems="center" spacing={1}>
